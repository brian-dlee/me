    ...
    <div className={classNames("InfoCard", props.className)}>
      <Segment className="content">
        ...
        <p>
          ...
          including: web application development and systems design, GeoSpatial
          data processing, platform native solutions for realtime audio/video
          streaming, production AI model integration and infrastructure,
          autoscaling hardware-restricted applications in cloud environments,
          and distributing systems for high scalability.
        </p>
      </Segment>
    </div>
  );
